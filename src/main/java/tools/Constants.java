...
public class Constants {
    public final static double SIMILAR_SCORE_LINE = 0.8;
    public final static int MESSAGE_LENGTH1 = 13;
    public final static int MESSAGE_LENGTH2 = 10;
    public final static int SENSITIVE_WORD_LENGTH = 4;
    public final static int HOT_WORD_LENGTH = 3;
...
//    public final static String CATEGORY_URL = "http://192.168.1.106:8080/public_behavior/api/behavior.do";
    public static String WORDS_DISTANCE_URL = "";
    ...
    public final static String HOT_WORD = "hot_word";
    public final static String SENSITIVE_WORD = "sensitive_word";
}
